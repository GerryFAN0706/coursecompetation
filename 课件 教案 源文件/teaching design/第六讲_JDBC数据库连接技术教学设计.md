...
- 在第四讲中使用AI进行代码对比分析，在第五讲中使用AI进行安全审查，已建立"AI辅助学习但需批判审查"的基本素养
- 本讲将引入Cursor（AI代码编辑器）作为新的AI工具，引导学生体验"AI辅助代码生成"的同时强化安全审查意识
...
### 6.4 操作流程
```
第1步：教师讲解完JDBC六步曲后，学生在Cursor中输入注释描述需求（如"创建一个UserDAO类，包含按ID查询用户的方法"）
     ↓
第2步：Cursor自动生成DAO代码骨架，学生逐行对照六步曲检查生成代码的完整性和正确性
     ↓
第3步：学生向AI提问"请对比以下代码中Statement和PreparedStatement的写法，分析SQL注入风险"
     ↓
...
| 维度 | 传统课堂 | AI辅助课堂 |
|:---|:---|:---|
| 代码编写效率 | 学生手写六步曲代码耗时10-15分钟，频繁出现拼写和语法错误 | Cursor生成骨架仅需1分钟，学生将时间用于理解和审查 |
| SQL注入认知 | 教师口头讲解注入原理，学生难以形成直觉 | AI同时生成安全和不安全版本，学生通过对比直观理解 |
| 资源管理意识 | 学生容易遗忘finally块中的资源关闭 | AI生成的代码可能包含资源泄漏，学生在审查中强化资源管理意识 |
...
### AI辅助评价
- 教师可使用AI工具批量扫描学生提交的JDBC代码，自动检测是否存在Statement直接拼接SQL、资源未关闭、连接字符串硬编码等常见问题
- 鼓励学生将自己的DAO代码提交给AI进行"安全审计"，对比AI发现的问题与自己审查发现的问题，提升安全审查能力
