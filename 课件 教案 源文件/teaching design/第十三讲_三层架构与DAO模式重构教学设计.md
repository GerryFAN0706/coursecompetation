...
- 多数学生已习惯在遇到编码问题时借助AI提示获取解决思路，但较少利用AI进行架构层面的代码生成与审查
...
### 6.4 操作流程
```
第1步：教师在Cursor中输入Prompt——“为Java Web登录功能生成Controller-Service-DAO三层架构代码，使用Servlet和JDBC”
     ↓
...
| 维度 | 传统课堂 | AI辅助课堂 |
|:---|:---|:---|
| 代码结构建立速度 | 学生手动创建多个类文件，约需10–15分钟 | AI生成骨架后学生专注审查，约需3–5分钟 |
| 架构理解深度 | 侧重”如何写”，容易陷入语法细节 | 侧重”如何审”，聚焦架构规范与层间耦合判断 |
| 课堂参与度 | 部分学生因编码速度慢而掉队 | 统一起点，全员参与架构审查讨论 |
...
### AI辅助评价
- 教师可将学生提交的分层代码输入Cursor，让AI检测是否存在层间耦合（如Service中出现`HttpServletRequest`引用、DAO中包含业务判断逻辑等），作为辅助评分参考
- 利用AI工具对比学生代码与标准三层架构模板的结构差异，快速定位学生的常见误区并进行针对性反馈
