...
- 在第一讲中已体验过AI生成HTTP报文示例的辅助学习模式，初步建立了"先思考、再用AI验证"的学习意识
- 本讲将首次引入AI辅助编码工具（Cursor），需引导学生理解AI代码补全的原理边界，避免盲目接受AI生成的代码
...
### AI辅助评价
- 教师可通过Cursor的编辑历史功能，回溯学生在编码过程中接受了哪些AI建议、拒绝了哪些，评估学生的独立思考程度
- 课后作业要求学生在无AI辅助的环境下（普通文本编辑器）手写一个简单Servlet，与课堂AI辅助编码的版本进行对比，检验真实掌握程度
