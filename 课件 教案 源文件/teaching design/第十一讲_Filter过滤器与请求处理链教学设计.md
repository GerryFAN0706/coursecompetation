...
- 在第十讲MVC实战中，学生已体验过使用Cursor辅助调试的工作流程，初步建立了"先分析、再求助AI"的习惯
- 本讲将进一步引导学生使用Claude进行Filter配置方案的设计审查——从"AI辅助调试已有代码"升级为"AI辅助设计新方案"，培养学生对AI生成的配置建议进行安全性和合理性评估的批判性思维
...
第1步：学生根据实战任务明确过滤需求（如"需要统一编码+认证校验+日志记录三个Filter的组合方案"）
     ↓
第2步：在Claude中用自然语言描述需求，获取AI生成的Filter配置方案（包括代码与web.xml配置）
     ↓
...
### AI辅助评价
- 收集学生对AI生成Filter方案的审查记录，评估审查的深度与准确性——是否能识别URL Pattern匹配问题、Filter顺序问题、线程安全问题等关键缺陷
- 对比学生独立编写的Filter代码与AI生成方案的差异，评估学生在经过AI方案审查训练后，自身代码质量是否有所提升
