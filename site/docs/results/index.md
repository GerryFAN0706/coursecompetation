...
本页统计指标优先来自：`创新成果支撑材料/成效数据/成效数据汇总与图表说明.md`  
核心口径：2025秋实验组 `N=58` 对比 2024秋对照组 `N=62`，周期 `16周`。
...
1. 编译通过率：按首次提交编译状态自动统计。
2. 功能完整性：按实验清单逐项评分（满分10分）。
3. SQL安全意识：前后测 + 代码审查双维统计。
4. 相似度：MOSS 两两比对后取平均相似度趋势。
5. 审查时长：按环节计时并进行同批次均值比较。
