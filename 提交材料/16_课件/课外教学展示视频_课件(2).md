...
课程: Web应用开发 | 32学时(理论24+实验8) | 2学分
授课对象: 计算机科学与技术专业本科三年级 · 2个教学班 · 58人
XXX大学 · XXX学院 · 教师：XXX
...
###### Teaching Philosophy & Core Challenges
...
## <a href="https://javaweb-ai-teaching.github.io/coursecompetation/demo-tools/webdev-assistant/">WebDev助教</a> · 学情诊断与预习推送

###### AI Teaching Assistant - Learning Diagnostics
...
## <a href="https://javaweb-ai-teaching.github.io/coursecompetation/demo-tools/team-coach/">TeamCoach</a> · 课前团队状态检查
...
## <a href="https://javaweb-ai-teaching.github.io/coursecompetation/demo-tools/websec-challenge/">WebSec挑战</a> · 课后延续 + AI代码审查
...
**[插入图片]** AI反馈报告 + 学生二次提交对比截图
展示：AI指出问题→学生修改后的代码差异
...
## <a href="https://javaweb-ai-teaching.github.io/coursecompetation/demo-tools/team-coach/">TeamCoach</a> · 团队项目持续监控
...
## <a href="https://javaweb-ai-teaching.github.io/coursecompetation/demo-tools/webdev-assistant/">WebDev助教</a> · 课后持续支持
...
###### Cross-Lecture Data-Driven Teaching Loop
...
###### Ideological Integration & AI Usage Guidelines

<!-- _class: bq-red -->

> **价值引领 + 四道防线，实现"润物无声"的思政融合与AI规范使用**

**课程思政设计——以"数字中国与网络安全"为主线：**
...
**[插入图片]** 中科院一区Top期刊论文首页截图（匿名处理）

</div>

<div class="img-placeholder">

**[插入图片]** CPEC 2025一等奖论文+最佳报告奖证书截图（匿名处理）
