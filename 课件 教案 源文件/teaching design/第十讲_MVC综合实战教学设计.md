...
- 在前序单一技术学习阶段，学生已初步使用AI工具辅助理解API用法和代码片段生成
...
第2步：遇到运行时错误（如404/500），先自行阅读错误信息与堆栈，尝试判断问题出在哪一层
     ↓
第3步：将错误堆栈信息粘贴到Cursor的AI对话窗口，描述"我在做MVC图书列表项目，访问/listBooks时报错"，获取AI的分析建议
     ↓
第4步：根据AI提示的可能原因（如"转发路径/jsp/bookList.jsp不存在"或"BookDao中SQL表名拼写错误"），回到对应层次检查并修复代码，验证修复结果
```
...
### AI辅助评价
- 教师可收集学生在Cursor中与AI的对话记录（截图），分析学生的提问质量：是否能准确描述问题场景、是否先给出自己的判断再求助AI
- 对比使用AI辅助调试前后学生的项目完成率和代码质量，评估AI工具在MVC综合实战教学中的实际效果
