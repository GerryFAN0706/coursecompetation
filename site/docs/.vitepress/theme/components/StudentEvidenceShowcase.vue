  ...
  <section class="evi-wrap">
    ...
    <div class="evi-grid">
      <article v-for="item in items" :key="item.id" class="evi-card">
        ...
        <a class="evi-link" :href="item.pdf" target="_blank" rel="noreferrer">查看PDF证据</a>
      </article>
    </div>
  </section>
</template>
...
const items: EvidenceCard[] = [
  {
    ...
    pdf: "/assets/evidence/student/AI反馈报告样例_1.pdf"
  },
  {
    id: "EV-S02",
    type: "AI反馈报告",
    ...
    pdf: "/assets/evidence/student/AI反馈报告样例_2.pdf"
  },
  {
    id: "EV-S03",
    type: "前后对比",
    ...
    pdf: "/assets/evidence/student/代码修改前后对比_样例1_权限过滤器.pdf"
  },
  {
    id: "EV-S04",
    type: "前后对比",
    ...
    pdf: "/assets/evidence/student/代码修改前后对比_样例2_登出安全.pdf"
  },
  {
    id: "EV-S05",
    type: "前后对比",
    ...
    pdf: "/assets/evidence/student/代码修改前后对比_样例3_SQL注入修复.pdf"
  },
  {
    id: "EV-S06",
    type: "分层实验报告",
    ...
    pdf: "/assets/evidence/student/实验报告样例_基础层.pdf"
  },
  {
    id: "EV-S07",
    type: "分层实验报告",
    ...
    pdf: "/assets/evidence/student/实验报告样例_进阶层.pdf"
  },
  {
    id: "EV-S08",
    type: "分层实验报告",
    ...
    pdf: "/assets/evidence/student/实验报告样例_挑战层.pdf"
  }
];
</script>
