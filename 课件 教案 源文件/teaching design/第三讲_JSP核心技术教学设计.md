...
- 经过前两讲的训练，学生已初步建立"先理解原理、再借助AI验证"的学习模式，能够在Cursor中有选择地接受AI代码建议
- 本讲将进一步提升AI应用层次：从"AI辅助编码"升级为"AI生成模板 + 学生审查安全隐患"，培养学生对AI输出的批判性审查能力
- 需引导学生从"AI代写"转向"AI辅助思考与验证"
...
### AI辅助评价
- 教师可使用Cursor快速生成不同复杂度的JSP代码片段作为随堂测验题目，要求学生判断代码的输出结果或指出潜在问题
- 学生提交的JSP页面作业可通过AI工具进行自动化安全扫描（如检测未转义的表达式输出），辅助教师评估学生的安全编码意识
