...
<div class="info-box emerald">
  <span class="icon">📊</span>
  <div>
    <strong>数据实证：</strong>四层机制运转16周后，实验组首次编译通过率从基线75.9%提升至93.1%（+17.2pp），安全漏洞数从每份3.4降至1.2（-64.7%），教师审查效率提升63.7%。详细数据见 <a href="/coursecompetation/results/">成效与数据</a> 页面。
  </div>
</div>
...
<p class="section-lead">
本方案的每一项设计决策和成效数据均有完整的材料支撑。以下为关键文档与数据的索引入口，支持评审专家的快速定位与交叉验证。
</p>
