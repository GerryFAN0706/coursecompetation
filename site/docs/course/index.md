...
<div class="summary-grid">
  ...
  <div class="summary-card">
    <div class="summary-icon">🎯</div>
    <h3>课程目标</h3>
    <p>Web开发工程实践能力 + 安全意识 + 规范编码</p>
  </div>
  <div class="summary-card">
    <div class="summary-icon">🤖</div>
    <h3>AI赛道定位</h3>
    <p>课前-课中-课后全链路AI赋能教学闭环</p>
  </div>
</div>
...
<div class="flow-grid">
  <div class="flow-card">
    ...
    <h4>知识目标</h4>
    <p>掌握Servlet、JSP、Filter、Listener、三层架构等Web核心技术</p>
  </div>
  <div class="flow-card">
    <div class="step-num">A</div>
    <h4>能力目标</h4>
    <p>完成"开发→测试→审查→迭代"的项目化实践全流程</p>
  </div>
  <div class="flow-card">
    <div class="step-num">V</div>
    <h4>素养目标</h4>
    <p>建立"最小权限、默认拒绝、验证驱动"的安全工程思维</p>
  </div>
  <div class="flow-card">
    <div class="step-num">D</div>
    <h4>数字素养</h4>
    <p>掌握AI辅助编程与代码审查的规范使用方法</p>
  </div>
</div>
...
| 角色 | 主要职责 |
|---|---|
| **主讲教师** | 课程设计、课堂组织、AI提示词设计、评价标准制定 |
| **团队教师** | 资源建设、案例打磨、数据整理、平台维护 |
| **技术支持** | 教学平台开发、数据面板搭建、自动化脚本维护 |
